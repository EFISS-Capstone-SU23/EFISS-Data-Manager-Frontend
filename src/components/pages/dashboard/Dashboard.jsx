					...
					<form className="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
						<article className="mb-5">
							...
							<p className="mb-2 text-gray-900">
								...
								{' '}
								Lets schedule a kick-off meeting and workshop this week.
						...
						<article className="mb-5">
							...
							<p className="mb-2 text-gray-900">
								...
								{' '}
								Iam attaching our offer and pitch deck. Take your time
							...
							>
								...
								<ul className="pl-2 mb-4 space-y-3 text-gray-500 list-disc">
									...
									<li className="flex space-x-2">
										...
										<span className="leading-tight">
											Learn from competitors about what to do, and
											not to do
										</span>
									</li>
									<li className="flex space-x-2">
